...
// const Skills = () => {
//     const arr =["JAVA","DSA","Problem Solving","JavaSript","NodeJS","MongoDB","CSS","HTML","ExpressJS","Tailwind","Bootstrap","C/C++","Communication"];
//    const [skills,setSkills] =useState(arr);
//   return (
//     <>
//     <div className='mt-32 w-full'>
//  <div style={{ color:"rgb(179, 40, 108)" }} className='w-3/4 mx-auto' > <h1  className='  tracking-wide font-semibold  text-LG'>WHAT I DO</h1>
//  <h1 style={{ fontFamily: "Morganite" }} className='tracking-wider text-8xl'>SKILLS</h1></div>
//  <div className='p-2  w-3/4 mx-auto  flex flex-wrap gap-2 justify-center'>{skills.map((item,index)=>( <Capsule skill={item} key={index}></Capsule>))}
