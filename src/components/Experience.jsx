...
//  <div style={{ color:"rgb(179, 40, 108)" }} className='w-3/4 mx-auto' > <h1  className='  tracking-wide font-semibold  text-xl'>WHAT I'VE LEARNT</h1>
//  <h1 style={{ fontFamily: "Morganite" }} className='tracking-wider text-8xl'>EXPERIENCES</h1>
//  </div>
//  <Taship></Taship>
//  </div>
//     </>
