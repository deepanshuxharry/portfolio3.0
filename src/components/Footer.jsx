...
const Footer = () => {
  return (
    ...
    <div style={{ backgroundColor:"rgb(150, 60, 108)"}} className='h-40 w-full'>
        <div className='w-2/5  h-28 m-auto p-5 flex flex-wrap justify-center gap-4'>
        ...
        <div className='w-2/5 mx-auto p-1 mb-7 h-6 text-center text-white font-semibold' ><i>Made by Srishti Khurana.</i></div>
    </div>
    </>
  )
}
